...
rm $RPM_BUILD_ROOT%{_nvidia_libdir}/lib*_nvidia.so*
install -p -m 0755 libGLESv1_CM_nvidia.so.%{version}         $RPM_BUILD_ROOT%{_nvidia_libdir}/libGLESv1_CM.so.%{version}
install -p -m 0755 libGLESv2_nvidia.so.%{version}         $RPM_BUILD_ROOT%{_nvidia_libdir}/libGLESv2.so.%{version}
install -p -m 0755 libEGL_nvidia.so.%{version}         $RPM_BUILD_ROOT%{_nvidia_libdir}/libEGL.so.%{version}
install -p -m 0755 libGLX_nvidia.so.%{version}         $RPM_BUILD_ROOT%{_nvidia_libdir}/libGLX_nvidia.so.%{version}
